...
function serenity_lite_customizer_css() {
    ...
    <style type="text/css">
        ...
        section.contact {background-color: <?php echo esc_attr( get_theme_mod( 'serenity_lite_onepage_contact_bg_color', '#DD9933' ) ); ?>;}
        ...
        section.calltoaction .blacklayer {
            background-color: <?php echo esc_attr( get_theme_mod( 'serenity_lite_onepage_cta_bg_color', '#dd9933' ) ); ?>;
            opacity: 0.95;
        }
        .page-footer {background-color: <?php echo esc_attr( get_theme_mod( 'serenity_lite_footer_bg_color', '#DD9933' ) ); ?>;}
    </style>
    <?php
}
